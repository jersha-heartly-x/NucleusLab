exports.getCookie = (req, res, next) => {
    ...
    const formattedCookie = xamcsAuthCookie && xamcsRefreshCookie ? `x-amcs-auth=${encodeURIComponent(xamcsAuthCookie)}; x-amcs-refresh=${encodeURIComponent(xamcsRefreshCookie)}` : ""
